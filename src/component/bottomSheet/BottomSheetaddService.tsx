    ...
    <RBSheet
      ...
      <ScrollView
        ...
        <View style={{paddingBottom: 30}}>
          <TextInputCustom placeholder="Nhập tên gói" />
          <TextInputCustom placeholder="Thời hạn (ngày)" numeric />
          <TextInputCustom placeholder="Giá" numeric />
          <TextInputCustom placeholder="Dùng thử (ngày)" numeric />
          <SelectCustom title="Chọn sản phẩm" />
